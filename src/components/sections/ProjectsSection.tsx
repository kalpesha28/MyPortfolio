...
const projects = [
  ...
  },
  {
    id: '02',
    title: 'CodeCortex',
    subtitle: 'AI Codebase Agent',
    type: 'FULL-STACK // AI // RAG',
    icon: <Lock size={16} />,
    status: 'LIVE',
    client: 'Production Build',
    year: '2026',
    description: 'An AI-powered developer agent that ingests whole GitHub repos/PRs for semantic querying. Built a custom RAG pipeline mapping Python/JS/TS files into Abstract Syntax Trees using Tree-sitter grammars to achieve elite contextual synthesis over raw text splitters.',
    tech: ['Next.js', 'FastAPI', 'Groq (Llama 3.3)', 'ChromaDB', 'Jina AI', 'Tree-sitter'],
    githubUrl: 'https://github.com/kalpesha28/CodeCortex',
    demoUrl: null, // Set to your video demo path or live URL when ready
    accent: '#00f3ff', 
    accentDim: 'rgba(0,243,255,0.12)',
    image: '/codecortex.mp4', 
  },
  {
    id: '03',
    title: 'RouteWise',
    subtitle: 'Logistics OS',
    type: 'MOBILE // FULL-STACK // ALGORITHMS',
    icon: <Lock size={16} />,
    status: 'COMPLETED',
    client: 'Independent Build',
    year: '2026',
    description: 'A free multi-stop route optimization engine built for Indian delivery partners. Combines Nearest Neighbor with 2-opt combinatorial optimization heuristics to compute optimal sequences, tracking COD workflows and computing real-time fuel metrics via a Supabase/PostgreSQL backend.',
    tech: ['React Native', 'Expo', 'Supabase', 'Leaflet', 'Google Places API', 'Zustand'],
    githubUrl: 'https://github.com/kalpesha28/RouteWise',
    demoUrl: null, 
    accent: '#a855f7', 
